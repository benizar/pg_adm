...
COMMENT ON FUNCTION normalize_space(TEXT) IS 'Normalizes the space in a string, removing any leading or trailing space and reducing any internal whitespace to one space character per occurrence.';
